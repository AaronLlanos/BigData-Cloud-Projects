...
public class ImpressionMapper extends Mapper<LongWritable, Text, Text, AvroValue<Session>> {
		...
		public void map(LongWritable key, Text value, Context context)
			...
			if(map.get("zip") != null){
				...
				impressionBuilder.setDma(zipDML.get(map.get("zip")));
			}
			if(map.get("listingzip") != null){
				impressionBuilder.setZip(map.get("listingzip"));
				impressionBuilder.setDma(zipDML.get(map.get("listingzip")));
			}
